...
public class MainActivity extends AppCompatActivity implements GetJsonData.OnDataAvailable,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerViewAdapter = new RecyclerViewAdapter(this, new ArrayList<Photo>());
        recyclerView.setAdapter(mRecyclerViewAdapter);

//        GetRawData getRawData = new GetRawData(this);
//        getRawData.execute("http://penny-2.herokuapp.com/chat/history");
    ...
    protected void onResume() {
        ...
        super.onResume();
        GetJsonData getJsonData = new GetJsonData(this,"http://penny-2.herokuapp.com/chat/history", "en-us", true);
